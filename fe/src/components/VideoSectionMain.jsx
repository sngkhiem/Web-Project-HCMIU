...
const VideoSectionMain = () => {
    ...
    return (
        <div className="hidden lg:block absolute z-20 bottom-0 left-1/2 transform -translate-x-1/2 py-8">
            <h2 className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-3xl font-bold text-white mb-4">Top Recommendations</h2>
...
export default VideoSectionMain
